        ...
        <div class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="mt-4">
                <div class="px-1">
                    ...
                    <!-- Manajemen Makanan -->
                    <a href="{{ route('admin.makanan') }}" class="block py-3 px-4 flex items-center text-blue-600 bg-blue-50 rounded-lg mt-2 transition-colors duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span class="ml-3 text-l font-medium">Manajemen Makanan</span>
                    </a>
                </div>
            </nav>
        </div>
