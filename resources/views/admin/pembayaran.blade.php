...
<body class="bg-gray-100 font-sans">
  ...
  <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white p-4 rounded-lg shadow-sm border border-green-100">
      ...
      <p class="text-xs text-green-500 mt-2"><i class="fas fa-arrow-up mr-1"></i> 12% dari bulan lalu</p>
    </div>
    ...
    <div class="modal-box max-w-md">
      ...
      <div class="mt-4 space-y-4">
        ...
        <div class="pt-4 border-t">
          ...
          <div class="flex items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-lg p-4">
