        ...
        <div class="w-64 bg-white shadow-md hidden md:block">
            ...
            <nav class="mt-4">
                <div class="px-1">
                    ...
                    <a href="{{ route('admin.meja') }}" class="block py-3 px-4 flex items-center text-blue-600 bg-blue-50 rounded-lg mt-2 transition-colors duration-200">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h18M3 12h18M3 20h18M12 4v16M3 4v16M21 4v16"></path>
                        </svg>
                        <span class="ml-3 text-l font-medium">Manajemen Meja Billiard</span>
                    </a>
