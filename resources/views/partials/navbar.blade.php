<nav class="bg-gray-900 p-4 fixed top-0 left-0 w-full z-50 animate-fade-in">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="hidden lg:flex space-x-4" id="menu">
                ...
                <li>
                    <a class="text-white hover:text-blue-500 nav-link" href="{{ route('lreservasi') }}">
                        Reservasi
                    </a>
                </li>
                <li>
        ...
        <div class="lg:hidden">
            <ul class="hidden flex-col space-y-2 mt-4 text-lg" id="mobile-menu">
                ...
                <li><a class="text-white hover:text-blue-500 block nav-link" href="{{ route('lreservasi') }}">Reservasi</a>
                </li>
