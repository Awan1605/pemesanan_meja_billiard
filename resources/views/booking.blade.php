                ...
                <div id="paymentDetails" class="hidden mt-4 p-4 bg-base-200 rounded-lg">
                    <div id="qrisDetails" class="hidden">
                        <div class="text-center">
                            ...
                            <p class="text-sm mt-2 text-gray-500">Total: <span id="qrisAmount" class="font-bold"></span>
                            </p>
                        </div>
                    </div>
    ...
    <dialog id="successModal" class="modal">
        <div class="modal-box text-center">
            ...
            <div class="modal-action justify-center">
                <button class="btn btn-primary" onclick="window.location.href='/about2'">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        bookingForm.addEventListener('submit', function (e) {
            ...
            if (drinkItems.root_calm > 0) {
                drinkSummary.push(`${drinkItems.root_calm} Root Calm (Rp ${(drinkItems.root_calm * DRINK_PRICES.root_calm).toLocaleString('id-ID')})`);
            }
            if (drinkItems.es_dagen > 0) {
                drinkSummary.push(`${drinkItems.es_dagen} Es Dagen (Rp ${(drinkItems.es_dagen * DRINK_PRICES.es_dagen).toLocaleString('id-ID')})`);
            }
            if (drinkItems.ice_tea > 0) {
                drinkSummary.push(`${drinkItems.ice_tea} Ice Tea (Rp ${(drinkItems.ice_tea * DRINK_PRICES.ice_tea).toLocaleString('id-ID')})`);
            }
        ...
        function renderBookingHistory() {
            ...
            bookingHistoryBody.innerHTML = bookings.map((booking, index) => {
                ...
                if (booking.status === 'Confirmed' || booking.status === 'Dikonfirmasi') badgeClass = 'badge-success';
                if (booking.status === 'Pending' || booking.status === 'Menunggu Konfirmasi') badgeClass = 'badge-warning';
                if (booking.status === 'Cancelled' || booking.status === 'Dibatalkan') badgeClass = 'badge-error';
