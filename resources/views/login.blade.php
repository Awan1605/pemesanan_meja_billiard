...
<body class="flex justify-center items-center min-h-screen bg-[#0e1424] px-4">
  <div class="container flex flex-col md:flex-row w-full max-w-[900px] bg-white shadow-md rounded-xl overflow-hidden animate-scale-up">
    <!-- Left Section -->
    ...
    <div class="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center animate-fade-in animation-delay-200">
      <h2 class="text-2xl md:text-3xl mb-6 md:mb-7 flex items-center justify-center gap-2.5 animate-fade-in animation-delay-400">
        Login Account
      </h2>
